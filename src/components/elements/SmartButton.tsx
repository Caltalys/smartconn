...
const SmartButton = ({ text, href, className = '' }: SmartButtonProps) => {
  return (
    <Link href={href} className={`relative flex items-center justify-center group bg-secondary cursor-pointer w-[180px] h-12 min-w-[180px] lg:w-[210px] lg:h-14 lg:min-w-[200px] ${className}`}>
