...
const destinationFolder = "src/types";

const files = [
  {
    src: path.join(__dirname, "../smartcom-cms/types/generated/contentTypes.d.ts"),
    dest: path.join(__dirname, `./${destinationFolder}/contentTypes.d.ts`),
  },
  {
    src: path.join(__dirname, "../smartcom-cms/types/generated/components.d.ts"),
